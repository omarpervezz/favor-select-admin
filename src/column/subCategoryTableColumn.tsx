...
import EditSubCategory from "@/components/molecules/categories/EditSubCategory";

export const subCategoryTableColumn: ColumnConfig[] = [
  {
    key: "categoryImage",
    type: "custom",
    label: "Image",
  ...
  },
  {
    ...
    type: "custom",
    label: "Actions",
    render: (row, token, refetch, categories) =>
      token !== undefined &&
      refetch &&
      categories && (
        <EditSubCategory
